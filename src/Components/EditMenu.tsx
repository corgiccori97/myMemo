...
const EditMenu = ({ onCopyClicked }:EditMenuProps) => {
    ...
    return (
        <>
        <button className="w-8 h-8 stamp-effect rounded-full z-10"
        ...
        <AnimatePresence>
            ...
            className="flex justify-center items-center bg-gray-300 text-black font-semibold p-2 ml-2 rounded-full text-sm z-0">
